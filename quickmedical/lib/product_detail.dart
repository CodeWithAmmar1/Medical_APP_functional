...
import 'package:quickmedical/data.dart';
...
class _ProductDetailState extends State<ProductDetail> {
  ...
  void addToCart() {
    setState(() {
      cartItems.add({
        "title": Data.datadetail[0],
        "price": Data.datadetail[1],
        "pellets": Data.datadetail[2],
        "count": 1
      });
    });
